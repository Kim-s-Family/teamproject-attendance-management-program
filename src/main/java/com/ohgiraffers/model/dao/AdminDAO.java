...
import com.ohgiraffers.control.AdminMenu;
...
public class AdminDAO {
    ...
    public void insertEmpInfo() {
        ...
        try {
            ...
            pstmt.setString(2, newEmp.getEmpPwd());
    ...
    public void changeEmpInfo() {
        ...
        try {
            ...
            pstmt.setString(1, changeEmp.getEmpPwd());
            pstmt.setString(2, changeEmp.getEmpName());
            pstmt.setString(3, changeEmp.getPhone());
            pstmt.setString(4, changeEmp.getEmail());
            pstmt.setString(5, changeEmp.getDepartmentCode());
            pstmt.setString(6, changeEmp.getPositionCode());
            pstmt.setString(7, changeEmp.getEmpIdentification());
            pstmt.setString(8, changeEmp.getPaymentCode());
            pstmt.setString(9, changeEmp.getEmpId());
    ...
    public void changeEmpAttendance() {
        ...
        while (true) {
            System.out.print("변경하실 날짜를 입력하세요 (ex : 20240131) : ");
...
//        for(Map<String, Integer> byPeriod : byPeriodInfoList) {
//            System.out.println(byPeriod);
//        }
    ...
    public List<Map<String, Object>> monthAllEmpPenaltyInfo(Connection con) {
        ...
        try {
            ...
            while (rset.next()) {
                ...
                monthAllEmp.put("월 ", rset.getString("month_name"));
