...
public class EmployeeDAO {
    ...
    public EmployeeDTO selectEmployeeId(Connection con) {
        ...
        try {
            ...
            String query = prop.getProperty("selectEmployeeId");
            ...
            if (rset.next()) {
                ...
                selectedEmp.setEmpPwd(rset.getString("emp_password"));
                selectedEmp.setEmpName(rset.getString("emp_name"));
                selectedEmp.setPhone(rset.getString("phone"));
                selectedEmp.setEmail(rset.getString("email"));
                selectedEmp.setDepartmentCode(rset.getString("department_code"));
                selectedEmp.setPositionCode(rset.getString("position_code"));
                selectedEmp.setEmpIdentification(rset.getString("emp_identification"));
                selectedEmp.setPaymentCode(rset.getString("payment_code"));
            }
